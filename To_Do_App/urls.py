...
urlpatterns = [
    ...
    path(
        "project/<int:pk>/tasks/", views.admin_project_tasks, name="admin_project_tasks"
    ),
    ...
    path(
        "admin-projects/delete/<int:pk>/", views.delete_project, name="delete_project"
    ),
    ...
    path(
        "task/<int:task_id>/<str:action>/",
        views.update_task_timer,
        name="update_task_timer",
    ),
    path("user-profile/", views.user_profile, name="user_profile"),
    path("completed-tasks/", views.complete_tasks, name="completed_tasks"),
